...
const Project = () => {
  return (
    <section id="Project"
      ...
      <div className="w-full max-w-6xl mx-auto bg-white/90 shadow-lg rounded-xl p-8 lg:p-12 flex flex-col lg:flex-row items-center gap-10 transition-transform hover:scale-[102%] hover:shadow-2xl mb-6 sm:mb-10 active:scale-[102%] active:shadow-2xl">
        {/* Image section */}
